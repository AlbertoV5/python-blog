...
#+subtitle: Find all images in a directory
...
#+begin_src python :eval yes :tangle ./blog/get_imgs.py :noweb strip-export
<<get_imgs>>
...
#+RESULTS[024ca6245fc6744e2a1019114470bf470114efdf]:
#+begin_example
