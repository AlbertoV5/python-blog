...
Note: Don't forget to commit your changes! You can also add a .gitignore template for Python and macOS: https://www.toptal.com/developers/gitignore/api/python,macos
